...
// todo: as @typescript to include type range
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        return new Promise((resolve, reject) => {
            const req = client(opt, res => {
                ...
                res.on('error', err => {
                    reject(err);
                    dataCollection.push(new util_1.TextEncoder().encode(err.message));
                });
                res.on('end', () => {
                    resolve(NewHttpResponse(dataCollection, res === null || res === void 0 ? void 0 : res.statusCode));
                });
            });
            if (![
                HttpMethod.GET,
                HttpMethod.DELETE,
            ].includes(context === null || context === void 0 ? void 0 : context.method)) {
